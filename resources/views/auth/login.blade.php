...
<div class="row m-0 align-items-center bg-white vh-100">
                    ...
                    <div class="card-body z-3 px-md-0 px-lg-4">
                        ...
                        <form action="{{ route('login.post') }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <p class="mt-3 text-center">
                                Tidak punya akun? <a href="{{ route('register.form') }}" class="text-underline">Silahkan registrasi</a>
                            </p>
                        </form>
                    </div>
                </div>
    ...
    <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
        <img src="{{ asset('hope-ui/html/assets/images/auth/01.png') }}" class="img-fluid gradient-main animated-scaleX" alt="images">
    </div>
</div>
@endsection

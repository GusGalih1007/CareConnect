    ...
    <div class="offcanvas-body data-scrollbar">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-grid gap-3 grid-cols-2 mb-4">
                    <div class="text-center">
                        <img src="{{ asset('hope-ui/html/assets/images/settings/dark/06.png') }}"
                        ...
                        <img src="{{ asset('hope-ui/html/assets/images/settings/light/06.png') }}"
                    ...
                    <div class="text-center">
                        ...
                        <img src="{{ asset('hope-ui/html/assets/images/settings/light/09.png') }}"

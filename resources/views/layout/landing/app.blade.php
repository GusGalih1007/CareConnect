...
<html lang="en" dir="ltr" class="landing-pages" data-bs-theme-color="theme-color-default">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="hope-ui/html/assets/css/core/libs.min.css">
      
      
      <!-- Hope Ui Design System Css -->
      <link rel="stylesheet" href="hope-ui/html/assets/css/hope-ui.min.css?v=5.0.0">
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="hope-ui/html/assets/css/custom.min.css?v=5.0.0">
      
      <!-- Customizer Css -->
      <link rel="stylesheet" href="hope-ui/html/assets/css/customizer.min.css?v=5.0.0">
      
      <!-- RTL Css -->
      <link rel="stylesheet" href="hope-ui/html/assets/css/rtl.min.css?v=5.0.0">
      
      
      <!-- SwiperSlider css -->
      <link rel="stylesheet" href="hope-ui/html/assets/vendor/swiperSlider/swiper-bundle.min.css">
      <link rel="stylesheet" href="hope-ui/html/landing-pages/assets/css/landing-pages.min.css">  </head>
            ...
            <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu">
              <div class="container-fluid navbar-inner">
                <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                    <a href="hope-ui/html/landing-pages/index.html" class="navbar-brand m-0 d-xl-flex d-none">
                        <!--Logo start-->
                       ...
                       <div class="d-flex align-items-center d-xl-none">
                          ...
                          <a href="hope-ui/html/landing-pages/index.html" class="navbar-brand ms-3  d-xl-none">
                                <!--Logo start-->
                                <svg class="icon-30 text-primary" width="30"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="-0.757324" y="19.2427" width="28" height="4" rx="2" transform="rotate(-45 -0.757324 19.2427)" fill="currentColor"></rect>
                                    <rect x="7.72803" y="27.728" width="28" height="4" rx="2" transform="rotate(-45 7.72803 27.728)" fill="currentColor"></rect>
                      ...
                      <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                        <li class="nav-item ">
                              ...
                              <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                  <li class="nav-item"><a class="nav-link active" href="hope-ui/html/landing-pages/index.html">App Landing Page</a></li>
                                  <li class="nav-item">
                                    <a class="nav-link " href="hope-ui/html/landing-pages/software-landing-page.html">
                                        Software Landing Page
                                    </a>
                                  </li>
                              </ul>
                          </li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/about.html">About Us </a></li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/feature.html"> Features </a></li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/pricing.html">Pricing</a></li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/blog.html">Blog</a></li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/faq.html">Faq</a></li>
                          <li class="nav-item"><a class="nav-link " href="hope-ui/html/landing-pages/contact-us.html">Contact Us</a></li>
                      </ul>
                    </div> <!-- container-fluid.// -->
                  </nav>
            <!-- Sidebar Menu End -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 banner-one-img text-center ms-2 ms-sm-0">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/banner-top.webp" alt="01" class="img-fluid ">
            </div>
            <div class="col-lg-5 inner-box">
                <div class="mb-2 text-uppercase text-primary sub-title">
                    Look fit, feel fit
                </div>
                <h1 class="text-secondary heading-title text-capitalize">The Joy Of<br><span class="text-primary">Right
                        Health</span></h1>
                <p class="title-text">It is a long established fact that a reader will be distracted by the readable
                    content
                    of a page when looking at its layout. </p>
                <div class="d-flex align-items-center store-btn">
                    <a href="#" class="btn btn-primary">Download Free</a>
                    <a href="#" class="btn btn-secondary ms-4">Download Pro</a>
                </div>
                    ...
                    <div class="d-flex mb-2  align-items-center">
                        <div class="border-end pe-2">
                            <div class="d-flex align-items-center">
                                ...
                                <svg class="ms-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    ...
                                    <path
                                        ...
                                        fill="#D9D9D9" />
                                    <mask id="mask0_1182_914" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="2"
                                        y="1" width="17" height="16">
                                        <path
                                            d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                            fill="#F2B827" />
                                    </mask>
                        ...
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/13.webp" alt="02"
                            class="img-fluid ps-2 star-icon">
                    </div>
                    <h6 class="mb-0 mt-1 text-black"><span>500k+</span> Downloads</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row mx-2 mx-sm-0">
            ...
            <div class="col-lg-6 top-feature">
                <div class="text-right">
                    ...
                    <h2 class="text-white notch-feature-txt heading-title text-capitalize heading-title">Top Notch Features </h2>
                    <p class="title-text mb-0">It is a long established fact that a reader will be distracted by
        ...
        <div class="row row-cols-sm-2 row-cols-lg-4">
            <div class="col">
                <div class="card services-box  rounded-1">
                    <div class="card-body p-0">
                        <h5 class="mb-3 ">400+ UI <br> Components</h5>
            ...
            <div class="col">
                <div class="card services-box  rounded-1">
                    <div class="card-body p-0">
                        <h5 class="mb-3">Refreshing<br> Design</h5>
            ...
            <div class="col">
                <div class="card services-box  rounded-1">
                    <div class="card-body p-0">
                        <h5 class="mb-3">Universal UI<br> Toolkit</h5>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        <svg class="text-primary" width="12" height="13" viewBox="0 0 12 13" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="col mb-4">
                <div class="card services-box  rounded-1">
                    <div class="card-body p-0">
                        <h5 class="mb-3">Fully<br> Responsive</h5>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        <svg class="text-primary" width="12" height="13" viewBox="0 0 12 13" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
...
<div class="section-padding">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/aboutus.webp" alt="03" class="img-fluid ">
            </div>
            <div class="col-md-6">
                <div class="mb-2 text-primary text-uppercase sub-title">
                    about us
                </div>
                <h2 class="text-secondary  text-capitalize heading-title">What they say <br> <span
                        class="text-primary">About
                        Us</span></h2>
                <p class="mb-4">It is a long established fact that a reader will be distracted by the readable content
                    of a page when looking at its layout. </p>
                <div class="d-flex align-items-center mb-lg-4 mb-3 about-icon-box">
                    <div class="p-2 border border-secondary rounded-1 d-flex text-secondary align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path
                                ...
                                stroke="#001F4C" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <span class="mb-0 ms-1">400+ UI Components</span>
                    </div>
                    <div class="p-2 border border-secondary rounded-1 d-flex text-secondary align-items-center ms-3">
                        ...
                        <span class="mb-0 ms-1">92+ CSS Designs</span>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
                ...
                <h2 class="text-secondary heading-title text-capitalize">Fast, easy, and <br> <span
                        class="text-primary">Affordable</span></h2>
                <p class="title-text">It is a long established fact that a reader will be distracted by the readable
                    content
                    of a page when looking at its layout. </p>
                <div class="d-flex align-items-center store-btn flex-wrap pt-2">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/playstore.webp" alt="04" class="img-fluid">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/appstore.webp" alt="05" class="img-fluid ms-3">
                </div>
                <div class="star-box mt-4">
                    <div class="d-flex mb-2  align-items-center">
                        <div class="border-end pe-2">
                            <div class="d-flex align-items-center">
                                ...
                                <svg class="ms-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    ...
                                    <path
                                        d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                        fill="#D9D9D9" />
                                    <mask id="mask0_1182_915" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="2"
                                        y="1" width="17" height="16">
                                        <path
                                            d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                            fill="#F2B827" />
            ...
            <div class="col-lg-7 mt-5 mt-lg-0">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/dwn-1.webp" alt="07" class="img-fluid d-block mx-auto">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4">
                ...
                <h2 class="text-secondary heading-title text-capitalize heading-title">Our <span class="text-primary">Price<br>
                        Plans</span>
                </h2>
                <p class="title-text">It is a long established fact that a reader will be distracted by the readable
                    content
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body my-2">
                                ...
                                <div class="d-flex justify-content-center align-items-baseline  mb-4">
                                    <h4 class="card-title pricing-card-title mb-0 text-primary">$15 </h4>
                                    <h6 class="mb-0"> / month</h6>
                                </div>
                                <p class="text-black mb-0">Billed Yearly</p>
                                <p class="text-black">$169.99 Billed Monthly</p>
                    ...
                    <div class="col iq-star-inserted-3">
                        <div class="card my-5">
                            <div class="card-body page-bg">
                                ...
                                <div class="d-flex justify-content-center align-items-baseline  mb-4">
                                    <h4 class="card-title pricing-card-title mb-0 text-primary">$49 </h4>
                                    <h6 class="mb-0"> / month</h6>
                                </div>
                                <p class="text-black mb-0">Billed Yearly</p>
                                <p class="text-black">$169.9 Billed Monthly</p>
                                <ul class="list-unstyled my-3 p-0">
                                    <li class="mb-3">30 users included</li>
                                    <li class="mb-3">15 GB of storage</li>
                                    <li class="mb-3">Call and email support</li>
                                    <li class="mb-3 text-decoration-line-through">Help center access</li>
                                    <li class="mb-3">Help center access</li>
                                    <li>Help center access</li>
                                </ul>
                                <button type="button" class="btn custom-btn btn-white w-100 shadow">Get Started</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <h2 class="text-secondary text-capitalize heading-title">Seamless User Experience, Assured!</h2>
                <p class="heading-main-title">It is specially designed for any kind of mobile app, software,
                    sass, startup,<br>marketing, one page and other online businesses. </p>
            </div>
        </div>
        <div class="row align-items-center justify-content-center ">
            <div class="col-lg-2 col-md-6">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/01.webp" alt="10"
                    class="img-fluid d-block mx-auto">
            </div>
             <div class="col-lg-2 col-md-6">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/02.webp" alt="11"
                    class="img-fluid d-block mx-auto">
             </div>
            <div class="col-lg-3 col-md-12">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/03.webp" alt="12"
                class="img-fluid d-block mx-auto">
            </div>
            <div class="col-lg-2 col-md-6">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/15.webp" alt="13"
                    class="img-fluid d-block mx-auto">
            </div>
            <div class="col-lg-2 col-md-6">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/16.webp" alt="14"
                class="img-fluid d-block mx-auto">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12 text-center">
                ...
                <h2 class="text-secondary heading-title text-capitalize">We are a team of dedicated <br><span
                        class="text-primary">professionals </span></h2>
                <p class="heading-main-title">It is a long established fact that a reader will be distracted by the readable
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4">
            <div class="col">
                <div class="card team-image">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/team1.webp" alt="team-details-01" class="img-fluid rounded-top" loading="lazy">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="my-2 line-count-1">Darlene
                                        Robertson</h6>
                            <svg class="text-primary"  width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g>
                                <path d="M7.45109 2.34305L7.46396 3.36381L12.0063 3.42098L2.05684 13.3704L2.78774 14.1013L12.7371 4.15187L12.7943 8.69414L13.8151 8.707L13.736 2.4221L7.45109 2.34305Z" fill="currentColor"/>
                            </g>
                            <defs>
                        ...
                        <p class="mb-0 text-primary">Founder</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card team-image">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/team2.webp" alt="team-details-02" class="img-fluid rounded-top" loading="lazy">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="my-2 line-count-1">Floyd Miles</h6>
                            <svg class="text-primary"  width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g>
                                <path d="M7.45109 2.34305L7.46396 3.36381L12.0063 3.42098L2.05684 13.3704L2.78774 14.1013L12.7371 4.15187L12.7943 8.69414L13.8151 8.707L13.736 2.4221L7.45109 2.34305Z" fill="currentColor"/>
                            </g>
                        ...
                        <p class="mb-0 text-primary">UI designer</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card team-image">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/team-3.webp" alt="team-details-03" class="img-fluid rounded-top" loading="lazy">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="my-2 line-count-1">Arlene McCoy</h6>
                            <svg class="text-primary"  width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g>
                                <path d="M7.45109 2.34305L7.46396 3.36381L12.0063 3.42098L2.05684 13.3704L2.78774 14.1013L12.7371 4.15187L12.7943 8.69414L13.8151 8.707L13.736 2.4221L7.45109 2.34305Z" fill="currentColor"/>
                            </g>
                        ...
                        <p class="mb-0 text-primary">Researcher</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card team-image">
                    <img src="hope-ui/html/landing-pages/assets/images/home-1/team-4.webp" alt="team-details-04" class="img-fluid rounded-top" loading="lazy">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="my-2 line-count-1">Darlene
                                        Robertson</h6>
            ...
            <div class="overflow-hidden slider-circle-btn  app-slider">
                <ul class="p-0 m-0 swiper-wrapper list-inline">
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/04.webp" alt="blog-01" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 16,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">The
                                                Cheapest Destinations Of All Time, A List Of Beauty And Budget.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none">
                                    <path
                                        d="M6.2108 0.102935L6.22367 1.1237L10.766 1.18087L0.816548 11.1303L1.54744 11.8612L11.4969 1.91176L11.554 6.45402L12.5748 6.46689L12.4957 0.181986L6.2108 0.102935Z"
                                        fill="currentColor" />
                                </svg>
                            </div>
                        </div>                    </li>
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/05.webp" alt="blog-02" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 17,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">Technology that unwinds your potential.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none">
                                    <path
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/06.webp" alt="blog-03" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 18,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">Generating the best online environment.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none">
                                    <path
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/04.webp" alt="blog-04" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 19,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">The
                                                Cheapest Destinations Of All Time, A List Of Beauty And Budget.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/05.webp" alt="blog-05" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 20,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">Technology that unwinds your potential.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none">
                    ...
                    <li class="swiper-slide card-slide card overflow-hidden">
                        <img src="hope-ui/html/landing-pages/assets/images/home-1/06.webp" alt="blog-06" class="img-fluid" loading="lazy">
                        <div class="card-body blog-card">
                            <div class="sub-title text-primary mb-2">August 21,2023</div>
                            <a href="blog-detail.html" class="mt-2 h5 line-count-2">Generating the best online environment.</a>
                            <div class="mt-5">
                                <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12"
                                    fill="none">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <h2 class="text-secondary heading-main-title text-capitalize">Make something<br>
                    <span class="text-primary">great </span> out of nothing
                </h2>
            </div>
        </div>
        <div class="row align-items-center text-center row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 mt-4">
            <div class="col mb-lg-0 mb-4 border-end">
                 <h2 class=" mb-3 counter text-primary">3</h2>
                 <h6 class="mb-0">Best Designer Award</h6>            </div>
            <div class="col mb-lg-0 mb-4 border-end">
                 <h2 class=" mb-3 counter text-primary">50+</h2>
                 <h6 class="mb-0">Loyal Clients</h6>            </div>
            <div class="col border-end">
                 <h2 class=" mb-3 counter text-primary">158+</h2>
                 <h6 class="mb-0">Nominee Awards</h6>            </div>
            <div class="col">
                 <h2 class=" mb-3 counter text-primary">92+</h2>
                 <h6 class="mb-0">CSS Designs</h6>            </div>
        </div>
    </div>
</div>
    ...
    <div class="container client-list">
        <ul class="p-0 m-0 d-flex align-items-center gap-3  client-mrquee list-unstyled">
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/12.webp" alt="client-details-01"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/07.webp" alt="client-details-02"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/08.webp" alt="client-details-03"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/09.webp" alt="client-details-04"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/10.webp" alt="client-details-05"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/11.webp" alt="client-details-06"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/12.webp" alt="client-details-07"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/07.webp" alt="client-details-088"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/08.webp" alt="client-details-99"  loading="lazy">
            </li>
            <li class="client-list-img ">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/09.webp" alt="client-details-11"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/10.webp" alt="client-details-12"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/11.webp" alt="client-details-13"  loading="lazy">
            </li>
            <li class="client-list-img ">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/12.webp" alt="client-details-14"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/07.webp" alt="client-details-15"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/08.webp" alt="client-details-16"  loading="lazy">
            </li>
            <li class="client-list-img">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/09.webp" alt="client-details-17"  loading="lazy">
            </li>
                <li class="client-list-img ">
                <img src="hope-ui/html/landing-pages/assets/images/home-1/12.webp" alt="client-details-01"  loading="lazy">
            </li>
...
<div class="section-padding">
    <div class="container">
        <div class="row align-items-center text-center">
            <div class="col-lg-12">
                <div class="mb-2 text-uppercase text-primary sub-title">Testimony</div>
                <h2 class="text-secondary customer-txt heading-main-title text-capitalize">What our <span
                        class="text-primary">Customer’s </span>are saying</h2>
            </div>
            <div class="overflow-hidden slider-circle-btn" id="testimonial-slider">
                    <ul class="p-0 m-0 swiper-wrapper list-inline ">
                        <li class="swiper-slide">
                            
                            <p class=" mb-4 test-text">Torquatos nec eu, detr
                                                        ...
                                                        mei.</p>
                            <img src="hope-ui/html/landing-pages/assets/images/home-1/14.webp" class="img-fluid rounded-pill user-test-img mt-2 
                             mb-2" alt="test-01" loading="lazy">
                            <div class="mb-2">
                            ...
                            <h6 class="text-secondary mb-0">Elsa Schmidt</h6>
                            <p class="mb-0 text-primary">Spa</p>
                        </li>
                        <li class="swiper-slide">
                            ...
                            <p class=" mb-4 test-text">Torquatos nec eu, detr
                                                        ...
                                                        epicurei mea. Mea facilisis urbanitas.Torquatos nec eu, detr periculis ex, nihil expetendis in
                                                        mei.</p>
                            <img src="hope-ui/html/landing-pages/assets/images/home-1/17.webp" class="img-fluid rounded-pill user-test-img mt-2 
                             mb-2" alt="test-02" loading="lazy">
                            <div class="mb-2">
                                <svg  width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M7.63067 1.28789C7.76731 0.959376 8.23272 0.959376 8.36936 1.28789L10.0222 5.26187C10.0798 5.40037 10.2101 5.495 10.3596 5.50698L14.6498 5.85093C15.0045 5.87936 15.1483 6.32197 14.8781 6.55343L11.6094 9.35344C11.4954 9.45104 11.4457 9.60416 11.4805 9.75L12.4791 13.9366C12.5617 14.2826 12.1852 14.5562 11.8815 14.3707L8.20848 12.1273C8.08048 12.0491 7.91951 12.0491 7.7915 12.1273L4.11845 14.3707C3.81481 14.5562 3.43831 14.2826 3.52087 13.9366L4.51951 9.75C4.55431 9.60416 4.50456 9.45104 4.39065 9.35344L1.12193 6.55343C0.851714 6.32197 0.995529 5.87936 1.35019 5.85093L5.64043 5.50698C5.78995 5.495 5.92019 5.40037 5.9778 5.26187L7.63067 1.28789Z" fill="#FDB022"/>
                                    <defs>
                            ...
                            <h6 class="text-secondary mb-0">Leslie Alexander</h6>
                            <p class="mb-0 text-primary">Hair stylist</p>
                        </li>
                        <li class="swiper-slide">
                            ...
                            <p class=" mb-4 test-text">Torquatos nec eu, detr
                                                        ...
                                                        epicurei mea. Mea facilisis urbanitas.Torquatos nec eu, detr periculis ex, nihil expetendis in
                                                        mei.</p>
                            <img src="hope-ui/html/landing-pages/assets/images/home-1/18.webp" class="img-fluid rounded-pill user-test-img mt-2 
                             mb-2" alt="test-03" loading="lazy">
                            <div class="mb-2">
                                <svg  width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M7.63067 1.28789C7.76731 0.959376 8.23272 0.959376 8.36936 1.28789L10.0222 5.26187C10.0798 5.40037 10.2101 5.495 10.3596 5.50698L14.6498 5.85093C15.0045 5.87936 15.1483 6.32197 14.8781 6.55343L11.6094 9.35344C11.4954 9.45104 11.4457 9.60416 11.4805 9.75L12.4791 13.9366C12.5617 14.2826 12.1852 14.5562 11.8815 14.3707L8.20848 12.1273C8.08048 12.0491 7.91951 12.0491 7.7915 12.1273L4.11845 14.3707C3.81481 14.5562 3.43831 14.2826 3.52087 13.9366L4.51951 9.75C4.55431 9.60416 4.50456 9.45104 4.39065 9.35344L1.12193 6.55343C0.851714 6.32197 0.995529 5.87936 1.35019 5.85093L5.64043 5.50698C5.78995 5.495 5.92019 5.40037 5.9778 5.26187L7.63067 1.28789Z" fill="#FDB022"/>
                                    <defs>
                            ...
                            <h6 class="text-secondary mb-0">Robert Fox</h6>
                            <p class="mb-0 text-primary">Trainer</p>
                        </li>
                        <li class="swiper-slide">
          ...
          <footer>
              <div class="bg-secondary inner-box ">
                  <div class="container">
                      <div class="row">
                          <div class="col-md-4">
                              <a href="hope-ui/html/dashboard/index.html" class="navbar-brand  d-flex align-items-center">
                                  ...
                                  <h4 class="logo-title ms-3 text-white">Hope UI</h4>
                              </a>
                              <p class="mb-4 mt-4">It is a long established fact that a reader will be distracted by the readable
          ...
          </footer>    <div id ="back-to-top" style="display: none;">
    ...
    <a class="btn btn-fixed-end btn-primary btn-icon btn-landing" href="hope-ui/html/dashboard/index.html" target="_blank">
      Dashboard Demo
    </a>
    <!-- Library Bundle Script -->
    <script src="hope-ui/html/assets/js/core/libs.min.js"></script>
    
    <!-- External Library Bundle Script -->
    <script src="hope-ui/html/assets/js/core/external.min.js"></script>
    
    <!-- Widgetchart Script -->
    <script src="hope-ui/html/assets/js/charts/widgetcharts.js"></script>
    
    <!-- mapchart Script -->
    <script src="hope-ui/html/assets/js/charts/vectore-chart.js"></script>
    <script src="hope-ui/html/assets/js/charts/dashboard.js" ></script>
    
    <!-- fslightbox Script -->
    <script src="hope-ui/html/assets/js/plugins/fslightbox.js"></script>
    
    <!-- Settings Script -->
    <script src="hope-ui/html/assets/js/plugins/setting.js"></script>
    
    <!-- Slider-tab Script -->
    <script src="hope-ui/html/assets/js/plugins/slider-tabs.js"></script>
    
    <!-- Form Wizard Script -->
    <script src="hope-ui/html/assets/js/plugins/form-wizard.js"></script>
    
    <!-- AOS Animation Plugin-->
    
    <!-- App Script -->
    <script src="hope-ui/html/assets/js/hope-ui.js" defer></script>
    
    
    <!-- SwiperSlider Script -->
    <script src="hope-ui/html/assets/vendor/swiperSlider/swiper-bundle.min.js"></script>
     <script src="hope-ui/html/landing-pages/assets/js/custom.js" defer></script>  </body>
</html>
